...
void StartAlienAttackSequence(STRATEGYBLOCK *sbPtr) {
	...
	SetAlienShapeAnimSequence_Core(sbPtr, static_cast<enum HModelSequenceTypes>(thisAttack->Sequence_Type), thisAttack->Sub_Sequence,
...
static int StartAlienTaunt(STRATEGYBLOCK *sbPtr) {
	...
	if ((AlienIsAbleToStand(sbPtr))==0) {
		...
		{
			SetAlienShapeAnimSequence_Core(sbPtr, HMSQT_AlienCrouch, ACrSS_Taunt,-1,(ONE_FIXED>>3));
	...
	SetAlienShapeAnimSequence_Core(sbPtr,HMSQT_AlienStand, sub_sequence,-1,(ONE_FIXED>>3));
