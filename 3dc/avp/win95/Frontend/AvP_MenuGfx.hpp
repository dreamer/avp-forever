...
extern uint32_t AVPMENUGFX_CLOUDY;
extern uint32_t AVPMENUGFX_SMALL_FONT;
extern uint32_t AVPMENUGFX_COPYRIGHT_SCREEN;

extern uint32_t AVPMENUGFX_PRESENTS;
extern uint32_t AVPMENUGFX_AREBELLIONGAME;
extern uint32_t AVPMENUGFX_ALIENSVPREDATOR;

extern uint32_t AVPMENUGFX_SLIDERBAR;
extern uint32_t AVPMENUGFX_SLIDER;

extern uint32_t AVPMENUGFX_BACKDROP;
extern uint32_t AVPMENUGFX_ALIENS_LOGO;
extern uint32_t AVPMENUGFX_ALIEN_LOGO;
extern uint32_t AVPMENUGFX_MARINE_LOGO;
extern uint32_t AVPMENUGFX_PREDATOR_LOGO;

extern uint32_t AVPMENUGFX_GLOWY_LEFT;
extern uint32_t AVPMENUGFX_GLOWY_MIDDLE;
extern uint32_t AVPMENUGFX_GLOWY_RIGHT;

extern uint32_t AVPMENUGFX_MARINE_EPISODE1;
extern uint32_t AVPMENUGFX_MARINE_EPISODE2;
extern uint32_t AVPMENUGFX_MARINE_EPISODE3;
extern uint32_t AVPMENUGFX_MARINE_EPISODE4;
extern uint32_t AVPMENUGFX_MARINE_EPISODE5;
extern uint32_t AVPMENUGFX_MARINE_EPISODE6;

extern uint32_t AVPMENUGFX_MARINE_EPISODE7;
extern uint32_t AVPMENUGFX_MARINE_EPISODE8;
extern uint32_t AVPMENUGFX_MARINE_EPISODE9;
extern uint32_t AVPMENUGFX_MARINE_EPISODE10;
extern uint32_t AVPMENUGFX_MARINE_EPISODE11;

extern uint32_t AVPMENUGFX_PREDATOR_EPISODE1;
extern uint32_t AVPMENUGFX_PREDATOR_EPISODE2;
extern uint32_t AVPMENUGFX_PREDATOR_EPISODE3;
extern uint32_t AVPMENUGFX_PREDATOR_EPISODE4;
extern uint32_t AVPMENUGFX_PREDATOR_EPISODE5;
extern uint32_t AVPMENUGFX_PREDATOR_EPISODE6;

extern uint32_t AVPMENUGFX_PREDATOR_EPISODE7;
extern uint32_t AVPMENUGFX_PREDATOR_EPISODE8;
extern uint32_t AVPMENUGFX_PREDATOR_EPISODE9;
extern uint32_t AVPMENUGFX_PREDATOR_EPISODE10;
extern uint32_t AVPMENUGFX_PREDATOR_EPISODE11;

extern uint32_t AVPMENUGFX_ALIEN_EPISODE1;
extern uint32_t AVPMENUGFX_ALIEN_EPISODE2;
extern uint32_t AVPMENUGFX_ALIEN_EPISODE3;
extern uint32_t AVPMENUGFX_ALIEN_EPISODE4;
extern uint32_t AVPMENUGFX_ALIEN_EPISODE5;
extern uint32_t AVPMENUGFX_ALIEN_EPISODE6;
extern uint32_t AVPMENUGFX_ALIEN_EPISODE7;
extern uint32_t AVPMENUGFX_ALIEN_EPISODE8;
extern uint32_t AVPMENUGFX_ALIEN_EPISODE9;
extern uint32_t AVPMENUGFX_ALIEN_EPISODE10;

extern uint32_t AVPMENUGFX_WINNER_SCREEN;

extern uint32_t AVPMENUGFX_SPLASH_SCREEN1;
extern uint32_t AVPMENUGFX_SPLASH_SCREEN2;
extern uint32_t AVPMENUGFX_SPLASH_SCREEN3;
extern uint32_t AVPMENUGFX_SPLASH_SCREEN4;
extern uint32_t AVPMENUGFX_SPLASH_SCREEN5;
