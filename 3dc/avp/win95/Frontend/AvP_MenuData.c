...
AVPMENU_ELEMENT AvPMenu_Multiplayer_Config[]=
{
	...
	/* bjd - new menu text field for entering networking port number */
	{AVPMENU_ELEMENT_TEXTFIELD, 	TEXTSTRING_MULTIPLAYER_SESSIONNAME,	MAX_MULTIPLAYER_NAME_LENGTH,	&port,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_SESSIONNAME},
