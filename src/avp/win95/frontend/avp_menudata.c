...
{
	{AVPMENU_ELEMENT_GOTOMENU_GFX,	{.GfxID=AVPMENUGFX_ALIEN_LOGO},		{AVPMENU_ALIENLEVELS},{0},{0},  	TEXTSTRING_MAINMENU_SINGLEPLAYER_ALIEN},
	{AVPMENU_ELEMENT_GOTOMENU_GFX,	{.GfxID=AVPMENUGFX_MARINE_LOGO},		{AVPMENU_MARINELEVELS},{0},{0}, 	TEXTSTRING_MAINMENU_SINGLEPLAYER_MARINE},
	{AVPMENU_ELEMENT_GOTOMENU_GFX,	{.GfxID=AVPMENUGFX_PREDATOR_LOGO},		{AVPMENU_PREDATORLEVELS},{0},{0},	TEXTSTRING_MAINMENU_SINGLEPLAYER_PREDATOR},
